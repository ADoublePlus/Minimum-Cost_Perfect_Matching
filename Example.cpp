...
void MinimumCostPerfectMatching_Example(string filename)
{
    Graph G;
    vector<double> cost;
...
void MaximumMatching_Example(string filename)
{
...
int main(int argc, char* argv[])
{
    ...
    while (i < argc)
    {
        ...
        else if (a == "--min_weight")
        {
            algorithm = "min_weight";
        }
        else if (a == "--max")
        {
            algorithm = "max";
    ...
    {
        cout << "usage: ./example -f <filename> <--min_weight | --max>" << endl;
        cout << "--min_weight for minimum weight perfect matching" << endl;
    ...
    try
    {
        if (algorithm == "min_weight")
            MinimumCostPerfectMatching_Example(filename);
        else 
            MaximumMatching_Example(filename);
    }
